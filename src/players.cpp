...
HumanPlayer::HumanPlayer(int player_id, std::string player_name)
    : Player(player_id, player_name) {
        set_name(player_name.empty() ? get_default_name() : player_name);
        };
    std::string HumanPlayer::get_default_name() {
        return "Player_"+std::to_string(get_id());
        };
...
EasyBotPlayer::EasyBotPlayer(int player_id, std::string player_name)
    ...
    std::string EasyBotPlayer::get_default_name() {
        return "Easy_Bot";
        };
